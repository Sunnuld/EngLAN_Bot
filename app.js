...
var watchChannel
var argArray = [];
var argChannel = "667872102711427085";
...
bot.on('message', message => {
  ...
  if (message.content.toLowerCase().startsWith('tlp-arg')) {
    ...
    argChannel.send("Welcome to the game <@"+`${userid}`+">! Find the next clue attached to the pinned message, and feel free to use this chat to work together!");
  }
});
